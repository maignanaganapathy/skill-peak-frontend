...
const ContactForm = () => {
    ...
    const { register, handleSubmit, reset, formState: { errors, isSubmitting } } = useForm<ContactFormData>(); // Using types with useForm and isSubmitting
    ...
    const onSubmit = async (data: ContactFormData) => {
        try {
            ...
            reset();
            toast.success(response.message || 'Message sent successfully!'); // Display success message from backend or a default one
            navigate('/');
        } catch (error: any) {
            console.error("Failed to send contact form", error);
            toast.error(error.response?.data?.message || 'Failed to send message. Please try again.'); // Display error message from backend or a default one
        }
    };
